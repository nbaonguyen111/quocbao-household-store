        ...
        "TimKiemPage.useEffect": ()=>{
            ...
            if (searchTerm.trim()) {
                ...
                filtered = filtered.filter({
                    "TimKiemPage.useEffect": (p)=>p.name.toLowerCase().includes(lower) || p.description.toLowerCase().includes(lower)
                }["TimKiemPage.useEffect"]);
            }
            ...
            switch(sortBy){
                ...
                case "discount":
                    filtered = filtered.slice().sort({
                        "TimKiemPage.useEffect": (a, b)=>b.discount - a.discount
                    }["TimKiemPage.useEffect"]);
                    break;
                case "new":
                    filtered = filtered.slice().sort({
                ...
                case "price-asc":
                    filtered = filtered.slice().sort({
                        "TimKiemPage.useEffect": (a, b)=>a.price - b.price
                    }["TimKiemPage.useEffect"]);
                    break;
                case "price-desc":
                    filtered = filtered.slice().sort({
                        "TimKiemPage.useEffect": (a, b)=>b.price - a.price
                    }["TimKiemPage.useEffect"]);
                    break;
                default:
                    break;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                searchTerm.trim() === "" && selectedBrand === "all" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    style: {
                        textAlign: "center",
                        color: "#888",
                        fontSize: 18
...
_s(TimKiemPage, "pYhVdeG1MdOVO56Tilz0ze5m6xw=", false, function() {
    return [
...
//# sourceMappingURL=src_app_tim-kiem_page_jsx_4dc7f20f._.js.map