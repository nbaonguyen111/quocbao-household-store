...
"[project]/src/hook/useSettingWebsite.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>useWebsiteSettings)
});
...
function useWebsiteSettings() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchSettings() {
            try {
                const docRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firebase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'settings', 'metadata'); // ← tuỳ theo bạn lưu document này thế nào
                ...
                if (docSnap.exists()) {
                    ...
                    setSettings(data);
                    // Optional: Cache vào localStorage nếu cần
                    localStorage.setItem('websiteSettings', JSON.stringify(data));
                }
            } catch (error) {
                console.error("Không lấy được metadata từ Firestore:", error);
            }
        }
        fetchSettings();
    }, []);
...
"[project]/src/components/Metadata.jsx [app-ssr] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const e = new Error(`Could not parse module '[project]/src/components/Metadata.jsx'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__75e0ab0a._.js.map